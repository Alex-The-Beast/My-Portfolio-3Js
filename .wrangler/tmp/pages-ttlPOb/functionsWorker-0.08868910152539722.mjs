...
var propertyNames;
var requiredEnv = /* @__PURE__ */ __name((env, key) => {
  const value = env[key];
  if (!value) throw new Error(`Missing ${key}. Add it to your Cloudflare Pages environment variables.`);
  return value;
}, "requiredEnv");
var notionFetch = /* @__PURE__ */ __name(async (env, endpoint, options = {}) => {
...
var loadPropertyNames = /* @__PURE__ */ __name((env) => {
  propertyNames = {
...
var plainText = /* @__PURE__ */ __name((richText = []) => richText.map((item) => item.plain_text).join("").trim(), "plainText");
var getTitle = /* @__PURE__ */ __name((properties) => {
  const titleProperty = Object.values(properties).find(
    (property) => property?.type === "title"
  );
  return plainText(titleProperty?.title) || "Untitled update";
}, "getTitle");
var slugify = /* @__PURE__ */ __name((value) => value.toLowerCase().trim().replace(/&/g, " and ").replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, ""), "slugify");
var getSlugValue = /* @__PURE__ */ __name((property) => {
  if (!property) return "";
...
var getSlug = /* @__PURE__ */ __name((properties, title, pageId) => {
  const rawSlug = getSlugValue(properties[propertyNames.slug]);
  const slug = slugify(rawSlug || title);
  const fallback = pageId.replace(/-/g, "").slice(-8);
  return slug || fallback;
}, "getSlug");
var getRichText = /* @__PURE__ */ __name((properties, name) => plainText(properties[name]?.rich_text), "getRichText");
var getSelectName = /* @__PURE__ */ __name((property) => property?.select?.name || property?.status?.name || "", "getSelectName");
var getMultiSelect = /* @__PURE__ */ __name((property) => property?.multi_select?.map((item) => item.name) || [], "getMultiSelect");
var formatDate = /* @__PURE__ */ __name((env, rawDate) => {
...
var getPropertyDate = /* @__PURE__ */ __name((properties, name) => {
  const property = properties[name];
  return property?.date?.start || property?.created_time || property?.last_edited_time || "";
}, "getPropertyDate");
var getPublishedAt = /* @__PURE__ */ __name((env, properties, page) => formatDate(env, getPropertyDate(properties, propertyNames.date) || page.created_time), "getPublishedAt");
var getUpdatedAt = /* @__PURE__ */ __name((env, properties, page) => formatDate(env, getPropertyDate(properties, propertyNames.updatedAt) || page.last_edited_time), "getUpdatedAt");
var getBlockText = /* @__PURE__ */ __name((block) => {
  const value = block[block.type];
  return plainText(value?.rich_text);
}, "getBlockText");
var getFileObjectUrl = /* @__PURE__ */ __name((fileObject) => {
  if (!fileObject) return "";
  if (fileObject.type === "external") return fileObject.external?.url || "";
  if (fileObject.type === "file") return fileObject.file?.url || "";
  return "";
}, "getFileObjectUrl");
var getMissingMediaReason = /* @__PURE__ */ __name((fileObject) => {
...
var normalizeBlock = /* @__PURE__ */ __name((block) => {
...
var getPageBlocks = /* @__PURE__ */ __name(async (env, pageId) => {
  const blocks = [];
  let startCursor;
  do {
...
var getFirstDataSourceFromDatabase = /* @__PURE__ */ __name(async (env, databaseId) => {
...
var getDataSourceId = /* @__PURE__ */ __name(async (env) => {
...
var queryPages = /* @__PURE__ */ __name(async (env, dataSourceId) => {
  const body = {
...
var pageToUpdate = /* @__PURE__ */ __name(async (env, page) => {
...
var withUniqueSlugs = /* @__PURE__ */ __name((updates) => {
...
var fetchLearningUpdates = /* @__PURE__ */ __name(async (env) => {
...
var getCachedUpdates = /* @__PURE__ */ __name(async (env) => {
  if (!env.CONTENT_CACHE) return null;
  return env.CONTENT_CACHE.get(cacheKey, "json");
}, "getCachedUpdates");
var putCachedUpdates = /* @__PURE__ */ __name(async (env, payload) => {
...
// ../.wrangler/tmp/pages-ttlPOb/functionsRoutes-0.5825125005066949.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-OSxUtC/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-OSxUtC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.08868910152539722.mjs.map
